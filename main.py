...
class Oisol(commands.Bot):
    ...
    def _setup_oisol_db() -> None:
        with sqlite3.connect(OISOL_HOME_PATH / 'oisol.db') as conn:
            conn.cursor().executescript(
                ...
                CREATE TABLE IF NOT EXISTS GroupsStockpilesList(AssociationId TEXT, Region TEXT, Subregion TEXT, Code TEXT, Name TEXT, Type TEXT, Level TEXT, Owner INTEGER);
    ...
    async def fetch_available_shards(self) -> None:
        ...
        self.logger.info(f'Fetch available shards completed, current shards are {' '.join(self.connected_shards)}')
