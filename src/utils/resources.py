...
from .oisol_enums import DamageTypes, FoxholeOfficialNames
...
DAMAGE_TYPES_ATTRIBUTION = {
    FoxholeOfficialNames.AMMO_0_44MM: DamageTypes.LIGHT_KINETIC,
    FoxholeOfficialNames.AMMO_7_62MM: DamageTypes.LIGHT_KINETIC,
    FoxholeOfficialNames.AMMO_7_92MM: DamageTypes.LIGHT_KINETIC,
    FoxholeOfficialNames.AMMO_8MM: DamageTypes.LIGHT_KINETIC,
    FoxholeOfficialNames.AMMO_9MM: DamageTypes.LIGHT_KINETIC,
    FoxholeOfficialNames.HARPA: DamageTypes.LIGHT_KINETIC,
    FoxholeOfficialNames.BUCKSHOT: DamageTypes.LIGHT_KINETIC,
    FoxholeOfficialNames.INFANTRY_MINE: DamageTypes.LIGHT_KINETIC,
    FoxholeOfficialNames.AMMO_12_7MM: DamageTypes.HEAVY_KINETIC,
    FoxholeOfficialNames.AMMO_20MM: DamageTypes.ANTI_TANK_KINETIC,
    FoxholeOfficialNames.GARRISON_HOUSE: DamageTypes.ANTI_TANK_KINETIC_STRUCTURE,
    FoxholeOfficialNames.SAFE_HOUSE: DamageTypes.ANTI_TANK_KINETIC_STRUCTURE,
    FoxholeOfficialNames.TOWN_BASE: DamageTypes.ANTI_TANK_KINETIC_STRUCTURE,
    FoxholeOfficialNames.RELIC_BASE: DamageTypes.ANTI_TANK_KINETIC_STRUCTURE,
    FoxholeOfficialNames.AT_PILLBOX: DamageTypes.ANTI_TANK_KINETIC_STRUCTURE,
    FoxholeOfficialNames.BOMASTONE: DamageTypes.SHRAPNEL,
    FoxholeOfficialNames.MORTAR_SHRAPNEL_SHELL: DamageTypes.SHRAPNEL,
    FoxholeOfficialNames.MORTAR_FLARE_SHELL: DamageTypes.FLARE,
    FoxholeOfficialNames.GAS_GRENADE: DamageTypes.POISONOUS_GAS,
    FoxholeOfficialNames.AMMO_30MM: DamageTypes.EXPLOSIVE,
    FoxholeOfficialNames.AMMO_40MM: DamageTypes.EXPLOSIVE,
    FoxholeOfficialNames.AMMO_75MM: DamageTypes.EXPLOSIVE,
    FoxholeOfficialNames.MAMMON: DamageTypes.EXPLOSIVE,
    FoxholeOfficialNames.RPG: DamageTypes.EXPLOSIVE,
    FoxholeOfficialNames.TREMOLA_GRENADE: DamageTypes.EXPLOSIVE,
    FoxholeOfficialNames.AMMO_120MM: DamageTypes.HIGH_EXPLOSIVE,
    FoxholeOfficialNames.AMMO_150MM: DamageTypes.HIGH_EXPLOSIVE,
    FoxholeOfficialNames.AMMO_300MM: DamageTypes.HIGH_EXPLOSIVE,
    FoxholeOfficialNames.SEA_MINE: DamageTypes.HIGH_EXPLOSIVE,
    FoxholeOfficialNames.SEA_MINE_ALIAS: DamageTypes.HIGH_EXPLOSIVE,  # Alias of E680-S Rudder Lock
    FoxholeOfficialNames.DEPTH_CHARGE: DamageTypes.HIGH_EXPLOSIVE,
    FoxholeOfficialNames.DEPTH_CHARGE_ALIAS: DamageTypes.HIGH_EXPLOSIVE,  # Alias of Model-7 “Evie”
    FoxholeOfficialNames.TORPEDO: DamageTypes.HIGH_EXPLOSIVE,
    FoxholeOfficialNames.TORPEDO_ALIAS: DamageTypes.HIGH_EXPLOSIVE,  # Alias of Moray Torpedo
    FoxholeOfficialNames.MORTAR_SHELL: DamageTypes.HIGH_EXPLOSIVE,
    FoxholeOfficialNames.AMMO_250MM: DamageTypes.DEMOLITION,
    FoxholeOfficialNames.SATCHEL: DamageTypes.DEMOLITION,
    FoxholeOfficialNames.HAVOC_CHARGE: DamageTypes.DEMOLITION,
    FoxholeOfficialNames.HYDRA: DamageTypes.DEMOLITION,
    FoxholeOfficialNames.AMMO_68MM: DamageTypes.ARMOUR_PIERCING,
    FoxholeOfficialNames.AMMO_94_5MM: DamageTypes.ARMOUR_PIERCING,
    FoxholeOfficialNames.AP_RPG: DamageTypes.ARMOUR_PIERCING,
    FoxholeOfficialNames.ARC_RPG: DamageTypes.ARMOUR_PIERCING,
    FoxholeOfficialNames.IGNIFIST: DamageTypes.ARMOUR_PIERCING,
    FoxholeOfficialNames.TANK_MINE: DamageTypes.ANTI_TANK_EXPLOSIVE,
    FoxholeOfficialNames.STICKY_BOMB: DamageTypes.ANTI_TANK_EXPLOSIVE,
    FoxholeOfficialNames.VARSI: DamageTypes.ANTI_TANK_EXPLOSIVE,
    FoxholeOfficialNames.FLASK: DamageTypes.ANTI_TANK_EXPLOSIVE,
    FoxholeOfficialNames.FLAMETHROWER_AMMO: DamageTypes.INCENDIARY,  # Alias of Willow's Bane Ammo & “Molten Wind” v.II Ammo
    FoxholeOfficialNames.MOLTEN_WIND_AMMO: DamageTypes.INCENDIARY,
    FoxholeOfficialNames.FLAME_AMMO: DamageTypes.INCENDIARY,
    FoxholeOfficialNames.WILLOWS_BANE_AMMO: DamageTypes.INCENDIARY,
    FoxholeOfficialNames.HIGH_EXPLOSIVE_ROCKET: DamageTypes.INCENDIARY_HIGH_EXPLOSIVE,
    FoxholeOfficialNames.FIRE_ROCKET: DamageTypes.INCENDIARY_HIGH_EXPLOSIVE,
    FoxholeOfficialNames.MORTAR_INCENDIARY_SHELL: DamageTypes.INCENDIARY_HIGH_EXPLOSIVE,
    FoxholeOfficialNames.BAYONET: DamageTypes.MELEE,
    FoxholeOfficialNames.SWORD: DamageTypes.MELEE,
    FoxholeOfficialNames.CLUB: DamageTypes.MELEE,
    FoxholeOfficialNames.FISTS: DamageTypes.MELEE,
}
...
EMOJIS_FROM_DICT = {
    ...
    FoxholeOfficialNames.FLAMETHROWER_AMMO: '<:flamethrower_ammo:1317941667386490992>',
    FoxholeOfficialNames.FLAME_AMMO: '<:flame_ammo:1317941665016844392>',
    FoxholeOfficialNames.MORTAR_SHRAPNEL_SHELL: '<:shrapnel_mortar:1317941666019152012>',
    ...
    FoxholeOfficialNames.AMMO_7_62MM: '<:7_62mm:1088823887510388959>',
    FoxholeOfficialNames.AMMO_7_92MM: '<:7_92mm:1088823653027815424>',
    FoxholeOfficialNames.AMMO_9MM: '<:9mm:1088823410412503141>',
    FoxholeOfficialNames.AMMO_12_7MM: '<:12_7mm:1088826018883719281>',
    FoxholeOfficialNames.AMMO_20MM: '<:20mm:1088826350850281492>',
    FoxholeOfficialNames.AMMO_30MM: '<:30mm:1077033326407335956>',
    FoxholeOfficialNames.AMMO_40MM: '<:40mm:1077032968310239292>',
    FoxholeOfficialNames.AMMO_68MM: '<:68mm:1077033006881063003>',
    FoxholeOfficialNames.AMMO_75MM: '<:75mm:1077033155749482546>',
    FoxholeOfficialNames.AMMO_94_5MM: '<:94_5mm:1077033020856483880>',
    FoxholeOfficialNames.AMMO_120MM: '<:120mm:1239625566655877201>',
    FoxholeOfficialNames.AMMO_150MM: '<:150mm:1239625565695119360>',
    FoxholeOfficialNames.AMMO_300MM: '<:300mm:1239625564428697640>',
    FoxholeOfficialNames.TORPEDO_ALIAS: '<:torpedo:1239625563057160345>',
    FoxholeOfficialNames.DEPTH_CHARGE_ALIAS: '<:depth_charge:1239625562373361737>',
    FoxholeOfficialNames.RPG: '<:rpg:1088828056073945179>',
    FoxholeOfficialNames.ARC_RPG: '<:arcrpg:1088830211799392316>',
    FoxholeOfficialNames.AMMO_250MM: '<:250mm:1239630880289329262>',
    FoxholeOfficialNames.HIGH_EXPLOSIVE_ROCKET: '<:3c_rocket:1239630879026970655>',
    FoxholeOfficialNames.FIRE_ROCKET: '<:4c_rocket:1239630881421791313>',
    FoxholeOfficialNames.HAVOC_CHARGE: '<:havoc:1240724687252623400>',
    FoxholeOfficialNames.MORTAR_SHELL: '<:mortar_shell:1240724693728755864>',
    FoxholeOfficialNames.SATCHEL: '<:satchel:1240724690054545479>',
    FoxholeOfficialNames.HYDRA: '<:hydras_whisper:1240724688523628565>',
    FoxholeOfficialNames.MAMMON: '<:mamon:1088827447128109146>',
    FoxholeOfficialNames.IGNIFIST: '<:ignifist:1088829111859949619>',
    FoxholeOfficialNames.AP_RPG: '<:aprpg:1088829901341212693>',
    FoxholeOfficialNames.FLASK: '<:flask:1088831037766893669>',
    FoxholeOfficialNames.STICKY_BOMB: '<:sticky:1088831015964909749>',
    FoxholeOfficialNames.VARSI: '<:varsi:1338643975984119890>',
    FoxholeOfficialNames.TANK_MINE: '<:landmine:1088831369762848850>',
    ...
    FoxholeOfficialNames.HARPA: '<:harpa:1088824018653679626>',
    FoxholeOfficialNames.BOMASTONE: '<:bomastone:1317941669785501840>',
    FoxholeOfficialNames.TREMOLA_GRENADE: '<:tremola:1088827774787125349>',
    'PT-815 Smoke Grenade': '<:smoke:1239713145375948840>',
    FoxholeOfficialNames.GAS_GRENADE: '<:gas:1239713326720880740>',
    FoxholeOfficialNames.SEA_MINE_ALIAS: '<:sea_mine:1244048778063773716>',
...
ITEMS_WIKI_ENTRIES = [
    ...
    {
        'name': FoxholeOfficialNames.IGNIFIST,
    ...
    {
        'name': FoxholeOfficialNames.AMMO_9MM,
    ...
    {
        'name': FoxholeOfficialNames.AMMO_7_92MM,
    ...
    {
        'name': FoxholeOfficialNames.MORTAR_SHELL,
