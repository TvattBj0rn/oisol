...
REGION_WIKI_ENTRIES = [
    ...
    } for k, v in REGIONS_TYPES.items()
]
...
ALL_WIKI_ENTRIES = ITEMS_WIKI_ENTRIES + VEHICLES_WIKI_ENTRIES + STRUCTURES_WIKI_ENTRIES + FACILITY_MATERIAL_ENTRIES + PLACEHOLDER_ENTRIES + REGION_WIKI_ENTRIES
