...
REGIONS_STOCKPILES = {
    ...
    'Weathered Expanse': [("Crow's Nest", FoxholeBuildings.STORAGE_DEPOT_NEUTRAL.value, FoxholeBuildings.STORAGE_DEPOT_WARDEN.value, FoxholeBuildings.STORAGE_DEPOT_COLONIAL.value), ("Wightwalk", FoxholeBuildings.STORAGE_DEPOT_NEUTRAL.value, FoxholeBuildings.STORAGE_DEPOT_WARDEN.value, FoxholeBuildings.STORAGE_DEPOT_COLONIAL.value), ('Foxcatcher', FoxholeBuildings.STORAGE_DEPOT_NEUTRAL.value, FoxholeBuildings.STORAGE_DEPOT_WARDEN.value, FoxholeBuildings.STORAGE_DEPOT_COLONIAL.value), ('The Weathering Halls', FoxholeBuildings.SEAPORT_NEUTRAL.value, FoxholeBuildings.SEAPORT_WARDEN.value, FoxholeBuildings.SEAPORT_COLONIAL.value)],
