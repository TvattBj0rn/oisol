...
REGIONS_STOCKPILES = {
    'Acrithia': ['Patridia', 'Legion Ranch','Thetus Ring'],
    "Allod's Bight": ["Mercy's Wail", 'Scurvyshire'],
    'Ash Fields': ['Ashtown', 'Electi'],
    'Basin Sionnach': ['Cuttail Station', 'The Den', 'Sess'],
    "Callahan's Passage": ['Lochan Berth', 'Solas Gorge'],
    "Callum's Cape": ['Holdout', "Callum's Keep"],
    'Clanshead Valley': ['The King', 'The Pike'],
    'Deadlands': ['The Salt Farms', 'Brine Glen', "Callahan's Gate", 'The Spine', 'Abandoned Ward'],
    'Endless Shore': ['Iron Junction', 'Brackish Point', 'Saltbrook Channel'],
    'Farranac Coast': ['Victa', 'Mara', 'The Jade Cove'],
    "Fisherman's Row": ["Hangmen's Court", 'Eidolo', 'Black Well', 'Partisan Island'],
    'Godcrofts': ['Blackwatch', 'The Axehead', 'Skodio'],
    'Great March': ['Violethome', "Myrmidon's Stay", 'Sitaria'],
    'Howl County': ['Hungry Wolf', 'Great Warden Dam', 'Little Lamb'],
    'Kalokai': ['Sweetearth', 'Hallow', 'Baccae Ridge'],
    'Loch Mór': ["Mercy's Wish", 'Feirmor'],
    'Marban Hollow': ['Lockheed', "Maiden's Veil"],
    "Morgen's Crossing": ['Allsight', 'Quietus', 'Lividus'],
    'Nevish Line': ['The Scrying Belt', 'Mistle Shrine', 'Blackcoat Way'],
    'Origin': ['Finis', 'Initium', 'Teichotima'],
    'Reaching Trail': ['Brodytown', 'Nightchurch', 'Reprieve'],
    'Red River': ['Penance', 'Judicium', 'Cannonsmoke'],
    'Schackeld Chasm': ['Savages', 'The Grave of Erastos', 'Silk Farm'],
    'Speaking Woods': ['Tine', 'Sotto Bank', 'The Filament'],
    'Stonecradle': ['Fading Lights', 'Buckler Sound'],
    'Tempest Island': ['Isle of Psyche', "Liar's Heaven", 'Alchimio Estate'],
    'Terminus': ['Therizó', "Warlord's Stead"],
    'The Drowned Vale': ['Loggerhead', 'The Baths'],
    'The Fingers': ['The Old Captain', 'The Routed', "Headsman's Villa"],
    'The Heartlands': ['Greenfield Orchard', 'The Blemish'],
    'The Linn of Mercy': ['The Prairie Bazaar', 'Ulster Falls'],
    'The Moors': ["Morrighan's Grave", 'Ogmaran'],
    'The Oarbreaker Isles': ['The Ides', 'Skelter Course', 'Integrum'],
    'Umbral Wildwood': ['Thunderfoot', "Hermit's Rest"],
    'Viper Pit': ['Earl Crowley', 'Kirknell'],
    'Weathered Expanse': ['Port of Rime', "Crow's Nest", 'Foxcatcher'],
    'Westgate': ['The Gallows', 'Kingstown', 'Longstone']
}